import os
import socket
from __file_writer import FileWriter
...
def check_socket(af_type, sock_type):
	...
	try:
		if af_type != "AF_INET" and af_type != "AF_INET6" and af_type != "AF_UNIX":
...
class Receiver:
	...
	def __init__(self, rcv_ip, rcv_port):
		...
		self.__ups = UnPackingSystem(DATA_PACKET_SIZE, DATA_SIZE)
	...
	def start_receiver(self):
		...
		packet = SWPacket(self.DATA_PACKET_SIZE, self.DATA_SIZE, self.PACKET_HEADER_SIZE, True)
